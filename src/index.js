...
import CodescapeSlider from './direflow-components/codescape-slider';

CodescapeSlider.then((element) => {

  /**
   * Access DOM node when it's mounted
   */
  console.log('codescape-slider is mounted on the DOM', element);
});
